...
### Maven
At the time of this writing, Maven doesn't yet run under the M1 chip natively, but it's pretty simple to install Maven running on Rosetta 2 via Homebrew. 
```console
