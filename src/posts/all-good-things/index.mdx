...
The best tutorial I could find for using content fragment models that I would eventually want to iterate through turned out to be in a [blog post](https://engineering.icf.com/aem-content-fragments-in-the-wild/) instead of any official Adobe documentation. 
