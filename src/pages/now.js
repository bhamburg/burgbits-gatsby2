        ...
        <Container>
          <Row>
            <Col xl={{ span: 8, offset: 2 }}>
              ...
              <p className="mb-4 h5">Last updated: December 23, 2020</p>
              ...
              <p>Missing "mumseason" with <a href="https://www.fralinger.org" target="_blank" rel="noopener noreferrer">Fralinger</a> and admittedly not practicing music enough. I'll eventually get back into the swing of things, but the lack of live gigs to prepare for has made it tough to stay motivated. 🪕</p>
              ...
              <p>Trying to reach my pleged <Link to="/reads">reading</Link> challenge goal of 20 books for 2020 but likely falling short. 📚</p>
              <p><Link to="/games">Playing video games</Link>, notably on PS5 and <a href="https://misterfpga.org" target="_blank" rel="noopener noreferrer">MiSTer</a>. 🕹 My tastes gravitate towards games from and inspired by the 8- and 16-bit “golden age” of pixel art. Kids can keep their Fortnite and Overwatch. Give me the “<abbr title="Nintendo Entertainment System">NES</abbr> Hard” platformers, run-and-guns, and <abbr title="role-playing games">RPGs</abbr>. I love to chat about <abbr title="cathode-ray tube">CRT</abbr> scan lines in 240p <abbr title="red-green-blue additive color model">RGB</abbr>, or the latest advances in <abbr title="field-programmable gate array">FPGA</abbr>-based systems with near-perfect accuracy and zero-to-low input latency. I even wrote a <Link to="/cutting-edge-of-retro-gaming">blog post</Link> about it.</p>
              <p><strike>Watching</strike> Just finished and can't stop talking about season 2 of <i>The Mandalorian</i>. 🤓</p>
